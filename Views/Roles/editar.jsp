...
<body>
	...
	<div class="jumbotron boxlogin">
		<form action="/roles/edit?id=<%=roles.getId() %>" method="post">
  			...
  			<label>Edite rol</label>
			<input type="text" name="nombre" placeholder="Edite el nombre" value="<%=roles.getNombre() %>" required class="form-control"> 
	...
	<footer id="pie">Valeria Nicoll Calderon Rodriguez -
	C.U.I:20162908 </footer>
	<script>
	(function(){
